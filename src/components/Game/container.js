...
import { getCurrentPlayer, getCurrentQuestion, getField, getGameOver, getPlayers, getQuestionAnswered, getQuestionIsClosed, getThemes, getWinner } from '../../redux/game-selectors';
